# Listen API: Podcast Search, Directory, and Insights API MCP Server

This MCP (Model Content Protocol) server provides access to Listen API: Podcast Search, Directory, and Insights API API functionality through HTTP, HTTPS, and STDIO transport modes.
